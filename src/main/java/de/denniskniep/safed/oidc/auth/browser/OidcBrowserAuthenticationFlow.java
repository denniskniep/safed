...
public class OidcBrowserAuthenticationFlow extends BrowserAuthenticationFlow<OidcAuthenticationRequest> {
    ...
    protected OidcAuthenticationRequest parse(RequestDataWithBody request) {
        ...
        oidcRequestData.setResponseMode(queryParams.get("response_mode"));
